...
class push extends Controller
{
    ...
    {
        // 设置GatewayWorker服务的Register服务ip和端口，请根据实际情况改成实际�?
       ...
       $uid = request()->param('uid');
        ...
        $point=new Points();
        $num=$point->countNum($room_id,$count['type']);//计算房间内有多少�?
        //用户是否在房间内
